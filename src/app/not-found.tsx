  ...
  return (
    <div className="studio-page min-h-screen bg-[#050a1e] text-white flex flex-col items-center justify-center px-5">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3">
        ...
        <Link
          href="/contact"
          className="inline-flex items-center rounded-xl border border-white/[0.15] px-6 py-2.5 text-base font-medium text-white hover:border-white/30 hover:bg-white/[0.04] active:scale-[0.98] transition-all"
        >
          Contactez-nous
        </Link>
      </div>
