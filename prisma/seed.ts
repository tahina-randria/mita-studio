...
async function main() {
  ...
  const heroContent = [
    ...
    { key: "hero_badge_2_value", value: "790 €", type: "text", section: "hero", label: "Badge 2 valeur" },
  ...
  const oneshotTiers = [
    {
      ...
      priceSuffix: "\u00a0€",
      description: "Une page, sobre et efficace. Votre activité en ligne en 2 semaines.",
      type: "oneshot",
      featured: false,
      sortOrder: 0,
    ...
    },
    {
      ...
      priceLabel: "À partir de",
      priceSuffix: "\u00a0€",
      description: "Multi-pages, référencement Google, blog. Le site complet pour être trouvé en ligne.",
      type: "oneshot",
      featured: true,
      sortOrder: 1,
    ...
    },
    {
      ...
      priceLabel: "",
      priceSuffix: "",
      description: "E-commerce, app web, intégrations. Projet sur mesure, de A à Z.",
      type: "oneshot",
      featured: false,
      sortOrder: 2,
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "À partir de 790 € TTC pour un site vitrine (offre de lancement). Le tarif dépend du nombre de pages, des fonctionnalités et du niveau de personnalisation. Chaque devis est définitif, pas de frais cachés.",
      category: "pricing",
      sortOrder: 1,
    },
    {
